...
bool readInputParameters(int argc, char *argv[], iwfm_track_options& iwtropt) {
	...
	config_opt.add_options()
		...
		("WELLRAD", po::value<double>()->default_value(10), "Number of particles per wells")
		...
		("STEPSIZE", po::value<double>()->default_value(50), "Initial Step size during particle tracking")
